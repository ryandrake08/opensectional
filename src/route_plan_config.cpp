...
namespace osect
{
    namespace
    {
        ...
        double parse_pref(const std::string& key, const std::string& value)
        {
            ...
            throw std::runtime_error("route_plan: unknown preference '" + value + "' for key '" + key +
    ...
    route_planner::options load_route_plan_options(const ini_config& ini)
    {
        ...
        o.wp_cost[static_cast<std::size_t>(ws::navaid_vor)] = pref_or(ini, "route_plan.route_waypoint_vor", REJ);
        o.wp_cost[static_cast<std::size_t>(ws::navaid_vortac)] = pref_or(ini, "route_plan.route_waypoint_vortac", REJ);
        o.wp_cost[static_cast<std::size_t>(ws::navaid_vor_dme)] = pref_or(ini, "route_plan.route_waypoint_vordme", REJ);
        o.wp_cost[static_cast<std::size_t>(ws::navaid_dme)] = pref_or(ini, "route_plan.route_waypoint_dme", REJ);
        o.wp_cost[static_cast<std::size_t>(ws::navaid_ndb)] = pref_or(ini, "route_plan.route_waypoint_ndb", REJ);
        o.wp_cost[static_cast<std::size_t>(ws::navaid_ndb_dme)] = pref_or(ini, "route_plan.route_waypoint_ndbdme", REJ);
        ...
        o.awy_cost[static_cast<std::size_t>(ac::jet)] = pref_or(ini, "route_plan.route_airway_jet", REJ);
        o.awy_cost[static_cast<std::size_t>(ac::rnav)] = pref_or(ini, "route_plan.route_airway_rnav", INCL);
        o.awy_cost[static_cast<std::size_t>(ac::color)] = pref_or(ini, "route_plan.route_airway_color", REJ);
        o.awy_cost[static_cast<std::size_t>(ac::other)] = pref_or(ini, "route_plan.route_airway_other", REJ);
