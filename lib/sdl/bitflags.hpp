...
struct bitflags
{
    ...
    friend bitflags operator|(bitflags a, bitflags b)
    {
        return bitflags(a.value | b.value);
    }
    friend bitflags operator&(bitflags a, bitflags b)
    {
        return bitflags(a.value & b.value);
    }
    friend bitflags operator~(bitflags a)
    {
        return bitflags(~a.value);
    }
    bitflags& operator|=(bitflags b)
    {
        value |= b.value;
        return *this;
    }
