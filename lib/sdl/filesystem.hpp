...
namespace sdl
{
    ...
    // Windows and Linux use a short application name.
    struct app_dirs
    {
        const char* macos; // e.g. "org.example.app"
        const char* other; // e.g. "exampleapp"
    };

    // Look up an asset (file or directory) under the platform user
    // configuration directory:
    //   macOS:   $HOME/Library/Application Support/<dirs.macos>/<name>
    //   Windows: %APPDATA%\<dirs.other>\<name>
    //   Linux:   ${XDG_CONFIG_HOME:-$HOME/.config}/<dirs.other>/<name>
